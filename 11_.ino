...
#define _DUTY_MIN 555 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1555 // servo neutral position (90 degree)
#define _DUTY_MAX 2555// servo full counterclockwise position (180 degree)
long _DUTY_MAP;
// global variables
